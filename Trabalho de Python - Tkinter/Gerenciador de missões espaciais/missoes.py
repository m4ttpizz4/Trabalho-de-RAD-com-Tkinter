    ...
    def atualizar_missao(conn, missao):
        ...
        sql = ''' UPDATE missao
                  SET nome = ?,
                      ...
                      status = ?
                  WHERE missao_id = ?'''
        cursor.execute(sql, (missao.nome,  missao.data_lancamento, missao.destino, missao.estado, missao.tripulacao, missao.carga_util, missao.duracao, missao.custo, missao.status, missao.missa_id))
        conn.commit()
